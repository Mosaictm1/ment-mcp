    ...
    return (
        <section className="section bg-[var(--bg-dark)]">
            <div className="container">
                <div className="max-w-2xl mx-auto text-center py-12 px-8 rounded-2xl bg-[var(--bg-card)] border border-[var(--border-dark)]">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center">
                        ...
                        <Link href="https://github.com/Mosaictm1/ment-mcp" className="btn btn-secondary px-6">
