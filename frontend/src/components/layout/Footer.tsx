...
export default function Footer() {
    return (
        <footer className="bg-[var(--bg-darker)] border-t border-[var(--border-dark)] py-12">
            <div className="container">
                <div className="flex flex-col md:flex-row justify-between items-start gap-8">
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-3">
                            ...
                            <span className="font-bold text-white">Ment MCP</span>
                        </div>
                ...
                <div className="mt-10 pt-6 border-t border-[var(--border-dark)] flex justify-between items-center text-xs text-[var(--text-dim)]">
                    <p>© {new Date().getFullYear()} Ment MCP. MIT License.</p>
                    <Link href="https://github.com/Mosaictm1/ment-mcp" className="hover:text-white transition">
